...
/**
 * Created by Mohamed Khalefa 2018
...
public class Game {
    ...
    public String checkGameWinner(char[][] grid) {
        ...
        if (grid[0][0] == 'x' && grid[0][0] == grid[0][1] && grid[0][1] == grid[0][2] ||
                grid[1][0] == 'x' && grid[1][0] == grid[1][1] && grid[1][1] == grid[1][2] ||
                grid[2][0] == 'x' && grid[2][0] == grid[2][1] && grid[2][1] == grid[2][2]) {
            return "X" + " wins";
        } else if (grid[0][0] == 'x' && grid[0][0] == grid[1][0] && grid[1][0] == grid[2][0] ||
                grid[0][1] == 'x' && grid[0][1] == grid[1][1] && grid[1][1] == grid[2][1] ||
                grid[0][2] == 'x' && grid[0][2] == grid[1][2] && grid[1][2] == grid[2][2]) {
            return "X" + " wins";
        }

        // Horizontal checks for o and Vertical checks for o
        if (grid[0][0] == 'o' && grid[0][0] == grid[0][1] && grid[0][1] == grid[0][2] ||
                grid[1][0] == 'o' &&grid[1][0] == grid[1][1] && grid[1][1] == grid[1][2] ||
                grid[2][0] == 'o' &&grid[2][0] == grid[2][1] && grid[2][1] == grid[2][2] )
        {
            return "O " +"wins";
        }
                ...
                grid[0][1] =='o'&&grid[0][1] == grid[1][1] && grid[1][1] == grid[2][1] ||
                grid[0][2] =='o' &&grid[0][2] == grid[1][2] && grid[1][2] == grid[2][2] ){
            return "O " + "wins";
        }
        // Diagonal checks for x and o

        if (grid[0][0] == 'x' && grid[0][0] == grid[1][1] && grid[1][1] == grid[2][2] ||
                grid[0][2] == 'x' && grid[0][2] == grid[1][1] && grid[1][1] == grid[2][0]) {
            return "X " + "wins";
        } else if (grid[0][0] == 'o' && grid[0][0] == grid[1][1] && grid[1][1] == grid[2][2] ||
                grid[0][2] == 'o' && grid[0][2] == grid[1][1] && grid[1][1] == grid[2][0]) {
            return "O " + "wins";
        } else if (freeSpots == 0) {
            return "its a tie";
        }
